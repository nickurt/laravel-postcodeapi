...
class PostcodesIOTest extends BaseProviderTest
{
    ...
    {
        $this->postcodesIO = (new PostcodesIO($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()));
    }
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://api.postcodes.io/postcodes?q=SW1A1AA', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
