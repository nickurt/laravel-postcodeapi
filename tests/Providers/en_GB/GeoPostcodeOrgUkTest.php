...
class GeoPostcodeOrkUkTest extends BaseProviderTest
{
    ...
    {
        $this->geoPostcodeOrgUk = (new GeoPostcodeOrgUk($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()));
    }
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $address = $this->geoPostcodeOrgUk->find('SW1A1AA');

        $this->assertSame('http://www.geopostcode.org.uk/api/SW1A1AA.json', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_an_invalid_postal_code()
    {
        ...
        $address = $this->geoPostcodeOrgUk->find('XW2A2AA');
