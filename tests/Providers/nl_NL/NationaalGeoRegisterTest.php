...
class NationaalGeoRegisterTest extends BaseProviderTest
{
    ...
    {
        $this->nationaalGeoRegister = (new NationaalGeoRegister($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()));
    }
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('http://geodata.nationaalgeoregister.nl/locatieserver/v3/free?q=postcode:1118CP&rows=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code()
    {
        ...
        $this->assertSame('http://geodata.nationaalgeoregister.nl/locatieserver/v3/free?q=postcode:1118CP%20and%20housenumber:202&rows=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
