...
class AdresseDataGouvTest extends BaseProviderTest
{
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://api-adresse.data.gouv.fr/search/?q=75007&postcode=&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://api-adresse.data.gouv.fr/search/?q=5+Avenue+Anatole+France&postcode=75007&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
