...
class NominatimTest extends BaseProviderTest
{
    ...
    {
        $this->nominatim = (new \nickurt\PostcodeApi\Providers\en_US\Nominatim($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()));
    }
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $address = $this->nominatim->find('92270');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=92270&addressdetails=1&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $address = $this->nominatim->find('1118CP');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=1118CP&addressdetails=1&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $address = $this->nominatim->find('SW1A 1AA');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=SW1A%201AA&addressdetails=1&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $address = $this->nominatim->setOptions(['countrycodes' => 'au'])->find('3066');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=3066&addressdetails=1&limit=1&countrycodes=au', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $address = $this->nominatim->find('75007');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=75007&addressdetails=1&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $address = $this->nominatim->setOptions(['countrycodes' => 'be'])->find('1000');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=1000&addressdetails=1&limit=1&countrycodes=be', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $address = $this->nominatim->find('10115');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=10115&addressdetails=1&limit=1', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $address = $this->nominatim->setOptions(['countrycodes' => 'at'])->find('1010');

        $this->assertSame('https://nominatim.openstreetmap.org/search?format=jsonv2&q=1010&addressdetails=1&limit=1&countrycodes=at', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_an_invalid_postal_code()
    {
        ...
        $address = $this->nominatim->find('zeroresults');
