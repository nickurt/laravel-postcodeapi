...
class AlgoliaTest extends BaseProviderTest
{
    ...
    public function setUp(): void
    {
        $this->algolia = (new \nickurt\PostcodeApi\Providers\en_US\Algolia(
            $this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()
        ))->setApiKey('YourAPIKey')->setApiSecret('YourApplicationId');
    }
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'us'])->find('92270');

        $this->assertSame(["countries" => "us", "query" => "92270", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'nl'])->find('1118CP');

        $this->assertSame(["countries" => "nl", "query" => "1118CP", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $address = $this->algolia->find('SW1A1AA');

        $this->assertSame(["query" => "SW1A1AA", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'au'])->find('3066');

        $this->assertSame(["countries" => "au", "query" => "3066", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'fr'])->find('75007');

        $this->assertSame(["countries" => "fr", "query" => "75007", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'be'])->find('1000');

        $this->assertSame(["countries" => "be", "query" => "1000", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'de'])->find('10115');

        $this->assertSame(["countries" => "de", "query" => "10115", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'at'])->find('1010');

        $this->assertSame(["countries" => "at", "query" => "1010", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_an_invalid_postal_code()
    {
        ...
        $address = $this->algolia->find('zeroresults');
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'us'])->findByPostcodeAndHouseNumber('92270', 1);

        $this->assertSame(["countries" => "us", "query" => "92270+1", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code2()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'nl'])->findByPostcodeAndHouseNumber('1118CP', 202);

        $this->assertSame(["countries" => "nl", "query" => "1118CP+202", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code3()
    {
        ...
        $address = $this->algolia->findByPostcodeAndHouseNumber('SW1A2AA', 10);

        $this->assertSame(["query" => "SW1A2AA+10", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code4()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'au'])->findByPostcodeAndHouseNumber('3066', 107);

        $this->assertSame(["countries" => "au", "query" => "3066+107", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code5()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'fr'])->findByPostcodeAndHouseNumber('75007', 2);

        $this->assertSame(["countries" => "fr", "query" => "75007+2", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code6()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'be'])->findByPostcodeAndHouseNumber('1000', 6);

        $this->assertSame(["countries" => "be", "query" => "1000+6", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code7()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'de'])->findByPostcodeAndHouseNumber('10115', 1);

        $this->assertSame(["countries" => "de", "query" => "10115+1", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code8()
    {
        ...
        $address = $this->algolia->setOptions(['countries' => 'at'])->findByPostcodeAndHouseNumber('1010', 2);

        $this->assertSame(["countries" => "at", "query" => "1010+2", "hitsPerPage" => 1], json_decode($this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getBody(), true));
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_an_invalid_postal_code()
    {
        ...
        $address = $this->algolia->findByPostcodeAndHouseNumber('zeroresults', 'zeroresults');
