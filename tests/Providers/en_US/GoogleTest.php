...
class GoogleTest extends BaseProviderTest
{
    ...
    {
        $this->google = (new Google($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=92270&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=1118CP&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=SW1A1AA&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=3066&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=75007&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=1000&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=10115&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=1010&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=92270+1&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code2()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=1118CP+202&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code3()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=SW1A2AA+10&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code4()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=3066+107&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code5()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=75007+2&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code6()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=1000+6&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code7()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=10115+1&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_by_postcode_and_house_number_a_valid_postal_code8()
    {
        ...
        $this->assertSame('Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', $this->google->getApiKey());
        $this->assertSame('https://maps.googleapis.com/maps/api/geocode/json?address=1010+2&key=Wrai_nwnetck2jlztk6vgwjaysrzbkzuvhhaaie', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
