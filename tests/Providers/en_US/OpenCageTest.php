...
class OpenCageTest extends TestCase
{
    ...
    {
        Http::fake(['https://api.opencagedata.com/geocode/v1/json?q=zeroresults&key=accy714xtv4ggfj0t7cpzvmznj0x3epk' => Http::response('{"documentation":"https://opencagedata.com/api","licenses":[{"name":"see attribution guide","url":"https://opencagedata.com/credits"}],"rate":{"limit":2500,"remaining":2487,"reset":1577059200},"results":[],"status":{"code":200,"message":"OK"},"stay_informed":{"blog":"https://blog.opencagedata.com","twitter":"https://twitter.com/opencagedata"},"thanks":"For using an OpenCage API","timestamp":{"created_http":"Sun, 22 Dec 2019 11:32:21 GMT","created_unix":1577014341},"total_results":0}')]);

        $address = $this->openCage->find('zeroresults');
