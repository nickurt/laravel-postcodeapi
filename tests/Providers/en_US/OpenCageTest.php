...
class OpenCageTest extends BaseProviderTest
{
    ...
    {
        $this->openCage = (new OpenCage($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=92270&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=us', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=1118CP&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=nl', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=SW1A1AA&key=accy714xtv4ggfj0t7cpzvmznj0x3epk', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=3066&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=au', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=75007&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=fr', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=1000&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=be', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=10115&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=de', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $this->assertSame('https://api.opencagedata.com/geocode/v1/json?q=1010&key=accy714xtv4ggfj0t7cpzvmznj0x3epk&countrycode=at', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
