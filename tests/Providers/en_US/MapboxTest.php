...
class MapboxTest extends BaseProviderTest
{
    ...
    {
        $this->mapBox = (new \nickurt\PostcodeApi\Providers\en_US\Mapbox($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $address = $this->mapBox->find('92270');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/92270.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $address = $this->mapBox->find('1118CP');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/1118CP.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $address = $this->mapBox->find('SW1A1AA');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/SW1A1AA.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $address = $this->mapBox->find('3066');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/3066.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $address = $this->mapBox->find('75007');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/75007.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $address = $this->mapBox->setOptions(['country' => 'be'])->find('1000');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/1000.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g&country=be', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $address = $this->mapBox->find('10115');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/10115.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $address = $this->mapBox->setOptions(['country' => 'at'])->find('1010');

        $this->assertSame('https://api.mapbox.com/geocoding/v5/mapbox.places/1010.json?access_token=pk.hd5FuVYvSRnJwzSQ2LJyyFQSWXuJEN5wTzgtGFcgxpWxRrWtATeQYLEuJxnPnqXAMZ.Or19S7KmYPHW8YjRz82v6g&country=at', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_an_invalid_postal_code()
    {
        ...
        $address = $this->mapBox->find('zeroresults');
