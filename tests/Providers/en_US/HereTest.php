...
class HereTest extends BaseProviderTest
{
    ...
    {
        $this->here = (new Here($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=92270&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&housenumber=42370&state=CA&street=Bob+Hope+Drive', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=1118CP&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=SW1A1AA&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=3066&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=AUS', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=75007&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=FRA', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=1000&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=BEL', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=10115&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=DE', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=1010&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=AT', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
