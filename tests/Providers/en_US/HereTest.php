...
class HereTest extends TestCase
{
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        $address = $this->here->setHttpClient(new Client([
            'handler' => new MockHandler([
                new Response(200, [], '{"Response":{"MetaInfo":{"Timestamp":"2019-08-03T20:49:16.460+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"houseNumber","MatchQuality":{"State":1.0,"City":1.0,"Street":[1.0],"HouseNumber":1.0},"MatchType":"pointAddress","Location":{"LocationId":"NT_fCLiZcIRSrsOwo2Gh19paB_0IzM3AD","LocationType":"address","DisplayPosition":{"Latitude":33.73865,"Longitude":-116.40715},"NavigationPosition":[{"Latitude":33.73868,"Longitude":-116.40809}],"MapView":{"TopLeft":{"Latitude":33.7397742,"Longitude":-116.4085018},"BottomRight":{"Latitude":33.7375258,"Longitude":-116.4057982}},"Address":{"Label":"42370 Bob Hope Dr, Rancho Mirage, CA 92270, United States","Country":"USA","State":"CA","County":"Riverside","City":"Rancho Mirage","Street":"Bob Hope Dr","HouseNumber":"42370","PostalCode":"92270","AdditionalData":[{"value":"United States","key":"CountryName"},{"value":"California","key":"StateName"},{"value":"Riverside","key":"CountyName"},{"value":"N","key":"PostalCodeType"}]}}}]}]}}')
            ]),
        ]))->find('42370+Bob+Hope+Drive,+Rancho+Mirage+CA');

        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=42370+Bob+Hope+Drive,+Rancho+Mirage+CA&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=8', $this->here->getRequestUrl());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        $address = $this->here->setHttpClient(new Client([
            'handler' => new MockHandler([
                new Response(200, [], '{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T07:04:19.187+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_-sYtJdLJ-kHPxUdkVsWWaC","LocationType":"area","DisplayPosition":{"Latitude":-37.79928,"Longitude":144.98755},"NavigationPosition":[{"Latitude":-37.79928,"Longitude":144.98755}],"MapView":{"TopLeft":{"Latitude":-37.7986363,"Longitude":144.9871063},"BottomRight":{"Latitude":-37.7999337,"Longitude":144.9879937}},"Address":{"Label":"3066, Melbourne, VIC, Australia","Country":"AUS","State":"VIC","City":"Melbourne","PostalCode":"3066","AdditionalData":[{"value":"Australia","key":"CountryName"},{"value":"Victoria","key":"StateName"}]}}}]}]}}')
            ]),
        ]))->find('3066+AUS');

        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=3066+AUS&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=8', $this->here->getRequestUrl());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        $address = $this->here->setHttpClient(new Client([
            'handler' => new MockHandler([
                new Response(200, [], '{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T07:04:48.759+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_0feW1KN2fl7OdCCtmK8gZC","LocationType":"area","DisplayPosition":{"Latitude":48.85462,"Longitude":2.31306},"NavigationPosition":[{"Latitude":48.85462,"Longitude":2.31306}],"MapView":{"TopLeft":{"Latitude":48.86406,"Longitude":2.28985},"BottomRight":{"Latitude":48.84591,"Longitude":2.3332799}},"Address":{"Label":"75007, Paris, Île-de-France, France","Country":"FRA","State":"Île-de-France","County":"Paris","City":"Paris","PostalCode":"75007","AdditionalData":[{"value":"France","key":"CountryName"},{"value":"Île-de-France","key":"StateName"},{"value":"Paris","key":"CountyName"}]}}}]}]}}')
            ]),
        ]))->find('75007+FRA');

        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=75007+FRA&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=8', $this->here->getRequestUrl());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        $address = $this->here->setHttpClient(new Client([
            'handler' => new MockHandler([
                new Response(200, [], '{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T07:05:18.298+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_mD95NW7dPHanUKsrTh4PpD","LocationType":"area","DisplayPosition":{"Latitude":50.86295,"Longitude":4.35338},"NavigationPosition":[{"Latitude":50.86295,"Longitude":4.35338}],"MapView":{"TopLeft":{"Latitude":50.89337,"Longitude":4.33755},"BottomRight":{"Latitude":50.79628,"Longitude":4.40193}},"Address":{"Label":"1000, Brussel, België","Country":"BEL","State":"Brussel","County":"Brussel","City":"Brussel","PostalCode":"1000","AdditionalData":[{"value":"België","key":"CountryName"},{"value":"Brussel","key":"StateName"},{"value":"Brussel","key":"CountyName"}]}}}]}]}}')
            ]),
        ]))->find('1000+BEL');

        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=1000+BEL&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=8', $this->here->getRequestUrl());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        $address = $this->here->setHttpClient(new Client([
            'handler' => new MockHandler([
                new Response(200, [], '{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T07:05:45.886+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_jKm69UMPlnMI8wzeyK1gHB","LocationType":"area","DisplayPosition":{"Latitude":52.53157,"Longitude":13.38344},"NavigationPosition":[{"Latitude":52.53157,"Longitude":13.38344}],"MapView":{"TopLeft":{"Latitude":52.53946,"Longitude":13.36569},"BottomRight":{"Latitude":52.52368,"Longitude":13.40161}},"Address":{"Label":"10115, Berlin, Deutschland","Country":"DEU","State":"Berlin","County":"Berlin","City":"Berlin","PostalCode":"10115","AdditionalData":[{"value":"Deutschland","key":"CountryName"},{"value":"Berlin","key":"StateName"},{"value":"Berlin","key":"CountyName"}]}}}]}]}}')
            ]),
        ]))->find('10115+DEU');

        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=10115+DEU&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=8', $this->here->getRequestUrl());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        $address = $this->here->setHttpClient(new Client([
            'handler' => new MockHandler([
                new Response(200, [], '{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T07:06:10.978+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_nv-GMSPYgc3dcPIJZMZxqD","LocationType":"area","DisplayPosition":{"Latitude":48.20908,"Longitude":16.36986},"NavigationPosition":[{"Latitude":48.20908,"Longitude":16.36986}],"MapView":{"TopLeft":{"Latitude":48.21858,"Longitude":16.35513},"BottomRight":{"Latitude":48.19961,"Longitude":16.38493}},"Address":{"Label":"1010, Wien, Österreich","Country":"AUT","State":"Wien","County":"Wien","City":"Wien","PostalCode":"1010","AdditionalData":[{"value":"Österreich","key":"CountryName"},{"value":"Wien","key":"StateName"},{"value":"Wien","key":"CountyName"}]}}}]}]}}')
            ]),
        ]))->find('1010+AUT');

        $this->assertSame('https://geocoder.api.here.com/6.2/geocode.json?postalCode=1010+AUT&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=8', $this->here->getRequestUrl());
