...
class HereTest extends TestCase
{
    ...
    {
        Http::fake(['https://geocoder.api.here.com/6.2/geocode.json?postalCode=1000&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=BEL' => Http::response('{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T12:02:33.977+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_mD95NW7dPHanUKsrTh4PpD","LocationType":"area","DisplayPosition":{"Latitude":50.86295,"Longitude":4.35338},"NavigationPosition":[{"Latitude":50.86295,"Longitude":4.35338}],"MapView":{"TopLeft":{"Latitude":50.89337,"Longitude":4.33755},"BottomRight":{"Latitude":50.79628,"Longitude":4.40193}},"Address":{"Label":"1000, Brussel, België","Country":"BEL","State":"Brussel","County":"Brussel","City":"Brussel","PostalCode":"1000","AdditionalData":[{"value":"België","key":"CountryName"},{"value":"Brussel","key":"StateName"},{"value":"Brussel","key":"CountyName"}]}}}]}]}}')]);

        $address = $this->here->setOptions(['country' => 'BEL'])->find('1000');
    ...
    {
        Http::fake(['https://geocoder.api.here.com/6.2/geocode.json?postalCode=10115&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=DE' => Http::response('{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T12:03:07.553+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_jKm69UMPlnMI8wzeyK1gHB","LocationType":"area","DisplayPosition":{"Latitude":52.53157,"Longitude":13.38344},"NavigationPosition":[{"Latitude":52.53157,"Longitude":13.38344}],"MapView":{"TopLeft":{"Latitude":52.53946,"Longitude":13.36569},"BottomRight":{"Latitude":52.52368,"Longitude":13.40161}},"Address":{"Label":"10115, Berlin, Deutschland","Country":"DEU","State":"Berlin","County":"Berlin","City":"Berlin","PostalCode":"10115","AdditionalData":[{"value":"Deutschland","key":"CountryName"},{"value":"Berlin","key":"StateName"},{"value":"Berlin","key":"CountyName"}]}}}]}]}}')]);

        $address = $this->here->setOptions(['country' => 'DE'])->find('10115');
    ...
    {
        Http::fake(['https://geocoder.api.here.com/6.2/geocode.json?postalCode=1010&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9&country=AT' => Http::response('{"Response":{"MetaInfo":{"Timestamp":"2019-08-04T12:03:43.209+0000"},"View":[{"_type":"SearchResultsViewType","ViewId":0,"Result":[{"Relevance":1.0,"MatchLevel":"postalCode","MatchQuality":{"Country":1.0,"PostalCode":1.0},"Location":{"LocationId":"NT_nv-GMSPYgc3dcPIJZMZxqD","LocationType":"area","DisplayPosition":{"Latitude":48.20908,"Longitude":16.36986},"NavigationPosition":[{"Latitude":48.20908,"Longitude":16.36986}],"MapView":{"TopLeft":{"Latitude":48.21858,"Longitude":16.35513},"BottomRight":{"Latitude":48.19961,"Longitude":16.38493}},"Address":{"Label":"1010, Wien, Österreich","Country":"AUT","State":"Wien","County":"Wien","City":"Wien","PostalCode":"1010","AdditionalData":[{"value":"Österreich","key":"CountryName"},{"value":"Wien","key":"StateName"},{"value":"Wien","key":"CountyName"}]}}}]}]}}')]);

        $address = $this->here->setOptions(['country' => 'AT'])->find('1010');
    ...
    {
        Http::fake(['https://geocoder.api.here.com/6.2/geocode.json?postalCode=zeroresults&app_id=Q28yv1juyWQexhHdoJ1P&app_code=pJKdj-mUwxw1thw8EjCX9v&gen=9' => Http::response('{"Response":{"MetaInfo":{"Timestamp":"2019-08-03T21:02:20.541+0000"},"View":[]}}')]);

        $address = $this->here->find('zeroresults');
