...
class GeocodioTest extends BaseProviderTest
{
    ...
    {
        $this->geocodio = (new Geocodio($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('qwertyuiop', $this->geocodio->getApiKey());
        $this->assertSame('https://api.geocod.io/v1.3/geocode/?q=92270&api_key=qwertyuiop', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
