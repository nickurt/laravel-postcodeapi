...
class LocationIQTest extends TestCase
{
    ...
    {
        Http::fake(['https://us1.locationiq.com/v1/search.php?q=92270&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=US' => Http::response('[{"place_id":"225177274","licence":"https:\/\/locationiq.com\/attribution","boundingbox":["33.766085028306","33.766185028306","-116.45253711222","-116.45243711222"],"lat":"33.7661350283064","lon":"-116.452487112216","display_name":"Rancho Mirage, California, USA","class":"place","type":"postcode","importance":0.335,"address":{"city":"Rancho Mirage","state":"California","postcode":"92270","country":"United States of America","country_code":"us","state_code":"ca"}}]')]);

        $address = $this->locationIQ->setOptions(['countrycodes' => 'US'])->find('92270');
    ...
    {
        Http::fake(['https://us1.locationiq.com/v1/search.php?q=SW1A%201AA&statecode=1&addressdetails=1&format=json&key=4390069143712a' => Http::response('[{"place_id":"226467527","licence":"https:\/\/locationiq.com\/attribution","boundingbox":["51.50095893648","51.50105893648","-0.14163760012261","-0.14153760012261"],"lat":"51.5010089364798","lon":"-0.141587600122614","display_name":"Westminster, SW1A 1AA, United Kingdom","class":"place","type":"postcode","importance":0.325,"address":{"city":"Westminster","postcode":"SW1A 1AA","country":"United Kingdom","country_code":"gb"}}]')]);

        $address = $this->locationIQ->find('SW1A%201AA');
    ...
    {
        Http::fake(['https://us1.locationiq.com/v1/search.php?q=zeroresults&statecode=1&addressdetails=1&format=json&key=4390069143712a' => fn () => throw new HttpClientException('{"error":"Unable to geocode"}', 404)]);
        ...
        $address = $this->locationIQ->find('zeroresults');
