...
class LocationIQTest extends BaseProviderTest
{
    ...
    {
        $this->locationIQ = (new \nickurt\PostcodeApi\Providers\en_US\LocationIQ($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=92270&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=US', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=1118CP&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=NL', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=SW1A%201AA&statecode=1&addressdetails=1&format=json&key=4390069143712a', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=3066&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=au', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=75007&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=fr', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=1000&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=be', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=10115&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=de', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $this->assertSame('https://us1.locationiq.com/v1/search.php?q=1010&statecode=1&addressdetails=1&format=json&key=4390069143712a&countrycodes=at', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
