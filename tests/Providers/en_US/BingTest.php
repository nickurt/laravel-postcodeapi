...
class BingTest extends BaseProviderTest
{
    ...
    {
        $this->bing = (new Bing($this->httpClient = new \nickurt\PostcodeApi\Http\Guzzle6HttpClient()))
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=92270&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code2()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=1118CP&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N&countryRegion=nl', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code3()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=SW1A1AA&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code4()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=3066&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N&countryRegion=AUS', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code5()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=75007&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N&countryRegion=FR', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code6()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=1000&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N&countryRegion=BE', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code7()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=10115&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N&countryRegion=DE', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
    ...
    public function it_can_get_the_correct_values_for_find_a_valid_postal_code8()
    {
        ...
        $this->assertSame('https://dev.virtualearth.net/REST/v1/Locations?postalCode=1010&key=KiDvfeMKAupV8LryymvklMJDEPJ4_04iLA2AN5Ayf4dUuwndTGlYPP3fOPFHXp0N&countryRegion=AT', (string)$this->httpClient->getHttpClient()->getConfig('handler')->getLastRequest()->getUri());
